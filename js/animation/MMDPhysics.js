...
THREE.MMDPhysics = ( function () {
	...
	MMDPhysics.prototype = {
		...
		update: function ( delta ) {
			...
			if( delta > 1 ){
				console.warn( 'delta time too long, so reset physics.' ,delta )
				this.reset();
				return;
			}
	...
	RigidBody.prototype = {
		...
		_init: function () {
			...
			//body.setCcdMotionThreshold( 0.00000001 );
			//body.setCcdSweptSphereRadius( motionThreshold/5 );			
		...
		_updateBoneRotation: function () {
			...
			// this.bone.quaternion.setFromRotationMatrix( matrixInv ).multiply( quaternion ).normalize();
	...
	Constraint.prototype = {
		...
		_init: function () {
			...
			// if(params.translationLimitation1[ 0 ] == 0){
			// 	console.log(params)
			// }
